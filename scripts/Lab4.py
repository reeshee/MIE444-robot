...
while RUN_COMMUNICATION_CLIENT:
    ...
    if responses[0]:
        ...
        # pause to allow the rover to finish moving
        time.sleep(LOOP_PAUSE_TIME)
        # Receive sensor readings
        sensor_front, sensor_right, sensor_left, sensor_back = check_sensors()
        #print readings in graphical-like format
        print(f".............{sensor_front}.............")
        print(f"..{sensor_left}...............{sensor_right}..")
        print(f".............{sensor_back}.............")
